...
public class frmCriarEspecialidade extends frmGenerico {
    ...
    private static final long serialVersionUID = 8362050299037863022L;
	/**
    ...
    private void initComponents() {
        ...
        setName("criar especialidade"); // NOI18N
        ...
        jLabel2.setText("CRIAR ESPECIALIDADE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCriarEspecialidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
