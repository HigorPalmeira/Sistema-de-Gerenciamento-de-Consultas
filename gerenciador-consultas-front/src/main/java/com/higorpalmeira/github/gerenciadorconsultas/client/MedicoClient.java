...
public class MedicoClient {
    ...
    public HttpResponse<String> buscarSaidaSimplesMedicoDtoPorId(UUID idMedico) throws IOException, InterruptedException {
    ...
    public HttpResponse<String> buscarSaidaSimplesMedicoDtoPorCrm(String crm) throws IOException, InterruptedException {
        
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(URL_API + "/crm/" + crm))
                .GET()
                .build();
    ...
    public HttpResponse<String> buscarSaidaSimplesMedicoDtoPorTelefone(String telefone) throws IOException, InterruptedException {
        
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(URL_API + "/telefone/" + telefone))
                .GET()
                .build();
    ...
    public HttpResponse<String> buscarMedicoDetalhadoPorId(UUID idMedico) throws IOException, InterruptedException {
        
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(URL_API + "/detalhes/" + idMedico))
                .GET()
                .build();
